...
import com.kerryprops.mp.service.CrewService;

public abstract class CrewControllerBase {
  protected static final String path = "api/crew";
  protected static final String listPath = "api/crew_list";
  protected static final String attachmentPath = "api/crew_attachment";
  protected static final String pathKey = "/{cwid}";
  ...
  public String get(
      ...
      @PathVariable Integer cwid,
      @RequestParam(required = false) String mask)
      throws Exception {
    CrewMask maskObj =
        mask == null || mask.equals("")
            ? new CrewMask().all(true)
            : new CrewMask(Long.valueOf(mask));
    Crew bean = onGet(session, request, response, cwid, maskObj);
    return jackson.writeValueAsString(bean);
  }

  @Nullable
  protected abstract Crew onGet(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nonnull Integer cwid,
      @Nonnull CrewMask mask)
      throws Exception;
  ...
  public String update(
    ...
    CrewMask maskObj =
        mask == null || mask.equals("")
            ? new CrewMask().all(true)
            : new CrewMask(Long.valueOf(mask));
    onUpdate(session, request, response, cwid, bean, maskObj);
    return jackson.writeValueAsString(bean);
  }

  @Nullable
  protected abstract Crew onUpdate(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nonnull Integer cwid,
  ...
  public void delete(
      ...
      @PathVariable Integer cwid)
      throws Exception {
    onDelete(session, request, response, cwid);
  }
  ...
  @Nonnull
  protected abstract List<Crew> onQuery(
      @Nonnull HttpSession session,
      @Nonnull HttpServletRequest request,
      @Nonnull HttpServletResponse response,
      @Nullable FilterExpr filter,
  ...
  public void downloadAttachment(
      ...
      throws Exception {
    InputStream input = inputStream(session, request, response, cwid, name);
  ...
  public void uploadAttachment(
      ...
      @RequestParam(required = true) String name)
      throws Exception {
    OutputStream output = outputStream(session, request, response, cwid, name);
  ...
  public void deleteAttachment(
      ...
      @RequestParam(required = true) String name)
      throws Exception {
    onDeleteAttachment(session, request, response, cwid, name);
  }
  ...
  public String listAttachments(
      ...
      @PathVariable Integer cwid)
      throws Exception {
    List<String> result = onListAttachments(session, request, response, cwid);

...
public abstract class UserRoleControllerBase {
  ...
  protected static final String listPath = "api/userrole_list";
  ...
  public String get(
    ...
    UserRoleMask maskObj =
        mask == null || mask.equals("")
            ...
            : new UserRoleMask(Long.valueOf(mask));
  ...
  protected abstract UserRole onGet(
      ...
      @Nonnull Integer urid,
      @Nonnull UserRoleMask mask)
      throws Exception;
  ...
  public void downloadAttachment(
      ...
      throws Exception {
    byte[] bytes = onReadAttachment(session, request, response, urid, name);
    if (bytes != null) {
  ...
  public void uploadAttachment(
    ...
    onWriteAttachment(session, request, response, urid, name, bytes);
  }
